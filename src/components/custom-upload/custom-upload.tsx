...
import MultiFilePreview from './custom-preview-multi-file';
import SingleFilePreview from './custom-preview-single-file';
...
export default function Upload({
  ...
  return (
    <Box component="div" sx={{ width: 1, position: 'relative', ...sx }}>
      <Box
        component="div"
        {...getRootProps()}
        sx={{
