...
const job = {
  ...
  experience: '10%',
  employmentTypes: ['1/Hr'],
  role: 'Manager',
  title: 'Box Breathing',
  createdAt: '2022-07-11T23:31:55.570Z',
};

const onView = () => console.log('ON_VIEW');
const onEdit = () => console.log('ON_EDIT');
const onDelete = () => console.log('ON_DELETE');
